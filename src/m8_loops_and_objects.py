...
def draw_circles2():
    """
    -- Constructs an rg.RoseWindow whose width and height are both 400. DONE
    -- Constructs and draws rg.Circle objects such that:
         -- Each has radius 10. DONE
         -- Each has fill_color 'blue'. DONE
         -- They are centered at, respectively: DONE
